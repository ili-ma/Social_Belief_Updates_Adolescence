...
load estimates_DDMTwoboundsCollapse_Prepped_ORA_29Jan2019.mat
...
for subjidx = 1:length(subjvec)
    subjidx;
            ...
            kpos_est     = pars_est(subjidx, 3);
            kneg_est     = pars_est(subjidx, 4);
            collapse     = pars_est(subjidx, 5);
            
            DeltaQ = computeCount_twobounds_collapse(T, kpos_est, kneg_est, collapse); 
