...
load estimates_optimalfull_ORA29Jan2019.mat
...
for subjidx = 1:length(subjvec)
    subjidx;
             % Estimates
            k_est     = pars_est(subjidx, 2);% beta0_est = pars_est(subjidx, 1);
            beta1_est = pars_est(subjidx, 3);
            c_est     = pars_est(subjidx, 4);
            
            risk_est   = pars_est(subjidx, 5);
            alpha_est  = pars_est(subjidx, 6);
            beta_est   = pars_est(subjidx, 7);
