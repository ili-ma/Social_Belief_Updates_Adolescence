...
load estimates_DDM_collapse_ORAprepped_29Jan2019.mat
...
for subjidx = 1:length(subjvec)
    subjidx;
            ...
            collapse_est         = pars_est(subjidx, 4);
           % priorDifference_est = pars_est(subjidx, 6);
            DeltaQ = computeDDM_collapse_ORA(T, m, k_est, collapse_est); % model specification computeCount_collapsingbound(T, m, k_est, collapse_est);
            beta1_est
            k_est
