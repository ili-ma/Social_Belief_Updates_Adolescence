% nBins = 10
% load summaryORA3
% load estimates_optimalFull_ORA3_19March2019; load invest_Optimal_ORA3;

function plotInvestVarBinsdeterminedbinsize_ORA(data, pars_est, softmax_pars_est, nBins)
...
for subjIdx = 1:nSubjects
    ...
    risk = pars_est(subjIdx, 5);%0;%change for sym and other models!!!!
    alpha_prior = pars_est(subjIdx, 6);
    beta_prior = pars_est(subjIdx, 7);
